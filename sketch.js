...
function setup() {
  ...
  gameObject1 = createSprite(100,200,60,60);
  gameObject1.shapeColor = "yellow";

  gameObject2 = createSprite(200,200,60,60);
  gameObject2.shapeColor = "cyan";

  gameObject3 = createSprite(300,200,60,60)
  gameObject3.shapeColor = "green";

  gameObject4 = createSprite(400,200,60,60);
  gameObject4.shapeColor = "pink";

  gameObject5 = createSprite(1100,30,60,60);
  gameObject5.shapeColor = "brown";

  gameObject5.velocityY= 5;
  

  gameObject6 = createSprite(1100,750,60,60);
  gameObject6.shapeColor = "purple";
